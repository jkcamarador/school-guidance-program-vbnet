...
Public Class G12StudentsList
    ...
    Private Sub datagridShow()
        ...
        If Form1.section = 1 Then
            da = New OleDb.OleDbDataAdapter("SELECT * FROM 01", connection)
        ElseIf Form1.section = 2 Then
            da = New OleDb.OleDbDataAdapter("SELECT * FROM 02", connection)
        ElseIf Form1.section = 3 Then
            da = New OleDb.OleDbDataAdapter("SELECT * FROM 03", connection)
        ElseIf Form1.section = 4 Then
            da = New OleDb.OleDbDataAdapter("SELECT * FROM 04", connection)
        Else
            da = New OleDb.OleDbDataAdapter("SELECT * FROM 05", connection)
        End If
